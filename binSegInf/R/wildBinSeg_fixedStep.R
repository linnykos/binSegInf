...
## #w# #' is_valid for semat; not using this because it destroys the data frame, makes it into a general structure, which screws code.
    ...
    for(mystep in 2:(numSteps+1)){
        ...
        .get_max.mbc <- function(Tcurr){
          ...
          max.m.b.cusums <- lapply(Tcurr, function(t){
            ...
            max.ind.of.maxcusums = which.max(maxcusums)
