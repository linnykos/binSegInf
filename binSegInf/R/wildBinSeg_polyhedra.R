#' Generate polyhedra matrix from wbs object. Forms both Gamma matrix and u
#' vector
#'
...
#' @export
polyhedra.wbs <- function(obj, ...){
    
    ## Check if obj is of class wbs.
    is_valid(obj)

    ##  
    obj <- .get_startEnd(obj$tree$name)[2] 
